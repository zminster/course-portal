...
<body class="report">
	...
	if ($method == 'POST') {	// POST
		...
		<form action="report_nti.php" method="POST">
			<p>Select term for which to generate report.</p>
