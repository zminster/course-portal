...
<body>
	...
	if ($method == 'POST') {	// POST
		...
		?><form action="chomp_pre.php" method="POST">
			...
			<div><label for="can_handin_all">Mark ALL as No Can Hand In?</label><input type="checkbox" id="can_handin_all" name="can_handin_all" /><p><em>If you don't mark all as can_handin=0, then students who have already turned in will still be marked can_handin=0 to prevent collisions.</em></p></div>
